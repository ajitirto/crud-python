...
#buat dan ktifkan database dari xampp dengan toko_mainan 
...
def show_data(db):
  ...
  cursor.execute(sql)
  #fetchcall menampilkan semua
  #fetchone menampilkan satu
...
#membuat aplikasi eksekusi terusdan exit untuk kelluar dari program
